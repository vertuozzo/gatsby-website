...
module.exports = {
  siteMetadata: {
    title: `Премиум аналитика по срочному и фондовому рынкам`,
    titleAlt: `Сайт для тех, кто торгует фьючерсами, опционами, CFD и акциями на российских и зарубежных площадках`,
    siteUrl: `https://vertuozzo.com`,
    description: `Данный сайт предназначен для трейдеров, которые торгуют фьючерсами, опционами, CFD и акциями на MOEX и CME`,
    headline: `Данный сайт предназначен для трейдеров, которые торгуют фьючерсами, опционами, CFD и акциями на MOEX и CME`,
    language: `ru`,
    image: `/banner.png`,
    author: `vertuozzo`,
  },
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `Сайт для тех, кто торгует фьючерсами, опционами, CFD и акциями на российских и зарубежных площадках`,
        short_name: `ТорговляФьючерсамиОпционамиCFDАкциями`,
        description: `Данный сайт предназначен для трейдеров, которые торгуют фьючерсами, опционами, CFD и акциями на MOEX и CME`,
        start_url: `/`,
