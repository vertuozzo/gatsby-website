...
module.exports = {
  siteMetadata: {
    title: `Премиум аналитика | MOEX CME`,
    ...
    description: `Данный сайт предназначен для трейдеров, которые торгуют фьючерсами, опционами, CFD и акциями`,
    headline: `Данный сайт предназначен для трейдеров, которые торгуют фьючерсами, опционами, CFD и акциями`,
    language: `ru`,
    image: `/banner.png`,
    author: `vertuozzo`,
  },
