...
const SEO = ({ description, meta, pathname, image, title, newsletter, datePublished, info }: Props) => {
  ...
  return (
    <Helmet meta={meta} defer={false}>
      ...
      <meta name="twitter:data1" value="https://vertuozzo.com" />
      <meta name="twitter:data2" value="https://vertuozzo.com" />
