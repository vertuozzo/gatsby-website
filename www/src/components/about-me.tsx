      ...
      <Container sx={{ mt: [6, 7], position: `relative` }}>
        ...
        >
          ...
          <Styled.p sx={{ textShadow: `0 1px 1px rgba(0, 0, 0, 0.2)` }}>
            Построена на графическом анализе (в каком-то смысле это ТА - поиск визуальных закономерностей). Обьемы (поток ордеров, level 2) - не использую. От уровней - не работаю. Свечной анализ - не принимаю.{` `}
            <span role="img" aria-label="Smile">
              😊
            </span>
			. Если вы решили полагаться на мою аналитику, то риск-менеджмент - на вас. Вход - известен, цели - известны, поэтому где ставить стопы - 1 к 3 / 1 к 4 (соотношение убытка к прибыли) (или доливаться) - решает каждый сам. Я, как и каждый, стремлюсь к совершенству, поэтому аналитика де-факто не предполагает то, что цена пойдёт не по плану.
          </Styled.p>
		  {/*
          <Flex
            sx={{
